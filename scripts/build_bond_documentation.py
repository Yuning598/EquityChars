...
def main() -> None:
    ...
    parser.add_argument("--definitions-output", default="docs/files/bond_characteristics_definitions.pdf")
    parser.add_argument("--calculation-tex", default="documents/formula_docs/bond_characteristics_calculation.tex")
    parser.add_argument("--calculation-output", default="docs/files/bond_characteristics_calculation.pdf")
