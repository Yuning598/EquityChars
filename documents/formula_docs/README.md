...
- `../../docs/files/equity_characteristics_calculation.pdf` — compiled PDF served by GitHub Pages.
...
3. Copy the PDF to the Pages folder:
   ...
   ```bash
   cp equity_characteristics_calculation.pdf ../../docs/files/equity_characteristics_calculation.pdf
   ```
